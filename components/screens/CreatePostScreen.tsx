    ...
    <SafeAreaView className="flex-1 bg-screen">
      ...
      >
        ...
        >
          ...
          <View className="my-4 flex-row items-start rounded-lg border border-l-4 border-primary !bg-primary/20 px-4 py-3">
            <Ionicons
          ...
          <View className="">
            <TouchableOpacity
              className="py-4 rounded-xl shadow-md bg-primary disabled:cursor-not-allowed disabled:bg-primaryLight"
